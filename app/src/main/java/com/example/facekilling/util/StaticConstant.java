...
public class StaticConstant {
    ...
    public static final int GETBITMAP_FROM_SD = 1;
    public static final int GETBITMAP_FROM_APP = 2;
    public static final int GETCOF_FROM_NEW = 3;
    public static final String FRONT_IP = "http://";
    public static final String IP = "10.14.170.147";
    public static final String PORT = "8000";
    public static final String FACE_ATTRIBUTE = FRONT_IP + IP + ":"+PORT+"/face/expression/";
    public static final String FACE_EXPRESSION = FRONT_IP+IP+":"+PORT+"/information/send/";
