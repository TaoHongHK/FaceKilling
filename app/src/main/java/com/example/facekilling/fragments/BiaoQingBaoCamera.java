...
public class BiaoQingBaoCamera extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_biaoqingbao_camera, container, false);
        initView();
        return mView;
    }

    private void initView() {
        iv_show = (ImageView) mView.findViewById(R.id.bqb_iv_show_camera);
        takePicButt = (Button) mView.findViewById(R.id.bqb_takePicButt);
        flipCamera = (Button) mView.findViewById(R.id.bqb_flipCamera);
        //mSurfaceView
        mSurfaceView = (SurfaceView) mView.findViewById(R.id.bqb_surface_view_camera);
